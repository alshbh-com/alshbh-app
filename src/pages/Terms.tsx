...
const Terms = () => {
  ...
  const sections = [
    {
      title: 'مقدمة',
      content: `مرحباً بك في تطبيق الشبح فود. باستخدامك لهذا التطبيق، فإنك توافق على الالتزام بهذه الشروط والأحكام. يرجى قراءتها بعناية قبل استخدام التطبيق.`,
    },
    {
      title: 'طبيعة الخدمة',
      content: `الشبح فود هو منصة وسيطة تربط بين المستخدمين والمطاعم. نحن لسنا مسؤولين عن جودة الطعام أو التأخير في التوصيل من قبل المطاعم الشريكة. أسماء المطاعم المعروضة هي لأغراض تنظيمية فقط.`,
    },
    {
    ...
    {
      title: 'حقوق الملكية',
      content: `جميع المحتويات والتصميمات في التطبيق هي ملك لمنصة الشبح فود. لا يجوز نسخ أو إعادة إنتاج أي جزء من التطبيق دون إذن كتابي.`,
    },
    {
      title: 'التعديلات',
